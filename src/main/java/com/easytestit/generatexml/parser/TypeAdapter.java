...
public abstract class TypeAdapter<T> {
     ...
     * Unlike Gson's similar {@link Json#toJson(JsonElement, Appendable) toJson}
     * method, this write is strict. Create a {@link
     * JsonWriter#setLenient(boolean) lenient} {@code JsonWriter} and call
     * {@link #write(com.easytestit.generatexml.parser.JsonWriter, Object)} for lenient
     * writing.
     *
     ...
     * similar {@link Json#fromJson(java.io.Reader, Class) fromJson} method, this
