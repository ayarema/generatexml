 ...
 * com.easytestit.generatexml.parser.JsonBuilder} for them to take effect: <pre> {@code
 *
 *  JsonBuilder builder = new JsonBuilder();
 *  builder.registerTypeAdapterFactory(new LowercaseEnumTypeAdapterFactory());
 *  ...
 *  JsonParser jsonParser = builder.create();
 * }</pre>
 ...
 * multiset's type token. A {@code JsonParser} is passed in to {@code create} for
 ...
 *       TypeAdapter<?> elementAdapter = jsonParser.getAdapter(TypeToken.get(elementType));
 ...
 * the foundation of how JsonParser converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
     ...
     * support {@code type}.
     */
    <T> TypeAdapter<T> create(JsonParser jsonParser, TypeToken<T> type);
}
