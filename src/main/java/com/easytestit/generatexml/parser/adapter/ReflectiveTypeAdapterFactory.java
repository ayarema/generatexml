...
import com.easytestit.generatexml.parser.ReflectionAccessor;
...
import com.easytestit.generatexml.parser.internal.Primitives;
...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    @Override public <T> TypeAdapter<T> create(JsonParser jsonParser, final TypeToken<T> type) {
        ...
        return new Adapter<T>(constructor, getBoundFields(jsonParser, type, raw));
    }

    private ReflectiveTypeAdapterFactory.BoundField createBoundField(
            final JsonParser context, final Field field, final String name,
    ...
    private Map<String, BoundField> getBoundFields(JsonParser context, TypeToken<?> type, Class<?> raw) {
