...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
    public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
        ...
        @Override public <T> TypeAdapter<T> create(JsonParser jsonParser, TypeToken<T> typeToken) {
            ...
            TypeAdapter<?> componentTypeAdapter = jsonParser.getAdapter(TypeToken.get(componentType));
            return new ArrayTypeAdapter(
                    jsonParser, componentTypeAdapter, $Json$Types.getRawType(componentType));
        }
    };
    ...
    public ArrayTypeAdapter(JsonParser context, TypeAdapter<E> componentTypeAdapter, Class<E> componentType) {
