...
import com.easytestit.generatexml.parser.JsonArray;
import com.easytestit.generatexml.parser.JsonElement;
import com.easytestit.generatexml.parser.JsonIOException;
import com.easytestit.generatexml.parser.JsonNull;
import com.easytestit.generatexml.parser.JsonObject;
import com.easytestit.generatexml.parser.JsonParser;
import com.easytestit.generatexml.parser.JsonPrimitive;
import com.easytestit.generatexml.parser.JsonSyntaxException;
import com.easytestit.generatexml.parser.annotations.SerializedName;
...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
        ...
        @Override public <T> TypeAdapter<T> create(JsonParser jsonParser, TypeToken<T> typeToken) {
            ...
            final TypeAdapter<Date> dateTypeAdapter = jsonParser.getAdapter(Date.class);
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
        ...
        return new TypeAdapterFactory() {
            ...
            @Override public <T2> TypeAdapter<T2> create(JsonParser jsonParser, TypeToken<T2> typeToken) {
