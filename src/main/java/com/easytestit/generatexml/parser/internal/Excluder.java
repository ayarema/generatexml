...
import com.easytestit.generatexml.parser.ExclusionStrategy;
...
import com.easytestit.generatexml.parser.annotations.Since;
import com.easytestit.generatexml.parser.annotations.Until;
...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public <T> TypeAdapter<T> create(final JsonParser jsonParser, final TypeToken<T> type) {
        ...
        return new TypeAdapter<T>() {
            ...
            private TypeAdapter<T> delegate() {
                ...
                return d != null
                        ? d
                        : (delegate = jsonParser.getDelegateAdapter(Excluder.this, type));
            }
        };
    }
