...
import com.easytestit.generatexml.com.google.gson.internal.JsonReaderInternalAccess;
import com.easytestit.generatexml.com.google.gson.internal.ObjectConstructor;
import com.easytestit.generatexml.com.google.gson.internal.Streams;
...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
    ...
    @Override public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        Class<?> rawTypeOfSrc = $Json$Types.getRawType(type);
        Type[] keyAndValueTypes = $Json$Types.getMapKeyAndValueTypes(type, rawTypeOfSrc);
